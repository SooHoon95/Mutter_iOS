...
description: Use when starting a non-trivial task, tracking progress, writing a work plan, or recording a correction. Trigger on tasks like "작업 계획", "todo.md", "lessons.md", "진행 추적", "교정 기록", "리뷰 섹션", "회고", "세션 시작".
...
2. **Verify Plan** — 구현 시작 전 계획을 사용자와 확인한다.
3. **Track Progress** — 항목을 완료할 때마다 체크 표시한다.
